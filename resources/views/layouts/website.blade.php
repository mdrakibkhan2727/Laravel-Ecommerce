                            ...
                            <li>
                                <div class="cart-item product-summary">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <div class="image">
                                                <a href="detail.html"><img src="{{ asset('assets/website/images/cart.jpg') }}" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-xs-7">
                                            ...
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                        <img class="img-responsive" src="{{ asset('assets/website/images/banners/top-menu-banner.jpg') }}" alt="">
                                            ...
                                            <div class="yamm-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                                                        <a href="#"><img alt="" src="{{ asset('assets/website/images/banners/banner-side.png') }}"></a>
                                                    </div>
                                                </div><!-- /.row -->
                                            </div><!-- /.yamm-content -->					</li>
                                    </ul>
